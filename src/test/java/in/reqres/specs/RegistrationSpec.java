...
public class RegistrationSpec {
    public static RequestSpecification successRequestRegistration = with()
    ...
    public static ResponseSpecification successResponseRegistration = new ResponseSpecBuilder()
